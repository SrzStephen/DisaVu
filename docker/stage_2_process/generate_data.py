...
if __name__ == "__main__":
    ...
    # The dataset is CC BY-NC-SA 4.0, the signup process is extremly easy.
    # Please use the Challenge training set (~7.8 GB) although you could probably get better results by augmenting other datasets from the challenge.
